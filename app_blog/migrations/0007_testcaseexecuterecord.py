# Generated by Django 2.2.4 on 2021-07-10 23:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_test_case', smart_selects.db_fields.GroupedForeignKey(group_field='belong_test_case', on_delete=django.db.models.deletion.CASCADE, to='app_blog.TestCase', verbose_name='所属用例')),
            ],
            options={
